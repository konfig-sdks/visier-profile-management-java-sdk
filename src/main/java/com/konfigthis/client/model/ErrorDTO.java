...
public class ErrorDTO {
  public static final String SERIALIZED_NAME_ROOT_CAUSE_ID = "rootCauseId";
  @SerializedName(SERIALIZED_NAME_ROOT_CAUSE_ID)
  ...
  public ErrorDTO rootCauseId(String rootCauseId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The root cause identifier that allows Visier to determine the source of the problem.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A brief identifier of the type of error.")
  ...
  **/
   ...
   * @return the ErrorDTO instance itself
   */
  public ErrorDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rootCauseId, errorDTO.rootCauseId) &&
        Objects.equals(this.errorCode, errorDTO.errorCode) &&
        Objects.equals(this.errorMessage, errorDTO.errorMessage)&&
        Objects.equals(this.additionalProperties, errorDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rootCauseId, errorCode, errorMessage, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("rootCauseId") != null && !jsonObj.get("rootCauseId").isJsonNull()) && !jsonObj.get("rootCauseId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rootCauseId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rootCauseId").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorDTO>() {
           ...
           public ErrorDTO read(JsonReader in) throws IOException {
             ...
             ErrorDTO instance = thisAdapter.fromJsonTree(jsonObj);
